...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
				String playerQA = JOptionPane.showInputDialog(null, "Would you like to yell or kick to attack?");
				// 4. If they typed in "yell":
					if (playerQA.equals ("yell")) {
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "You have defeated the dragon and are awarded tons of treasure");
		System.exit(0);   //This code ends the program
	}
